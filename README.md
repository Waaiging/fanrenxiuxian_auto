...
- 慢 `/charge-start` 回执会使服务端实际蓄力短于本地按住时间；在完美到达窗口与合法按住时长仍可兼顾时，会根据票据回执时间与正常网络延迟稍后释放。上报时长仍是实际按下到释放的间隔，成绩仍以服务端为准。
...
2026-09-14 入场验证超时与首窗延误见 [9 月 14 日复盘](docs/qingyuanzi_battle_20260914.md)；2026-09-15 战果、结束回执误计、迟唤醒与慢请求反馈见 [9 月 15 日复盘](docs/qingyuanzi_battle_20260915.md)。
